...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      ...
      ...defaultTheme.fontFamily, // keeps sans, serif, mono if needed
    },
    container: {
      center: true,
      padding: {
    ...
    extend: {
      // === VELOURA LUXURY COLORS (our custom palette) ===
      colors: {
        velourBlack: "#0F0F0F",
        velourGold: "#D4AF37",
        velourDarkGold: "#B8962C",
        velourWhite: "#FFFFFF",
        velourGray: "#1C1C1C",
        velourLightGray: "#2A2A2A",

        // You can keep your original colors below — they won't conflict
      ...
      spacing: {
        ...
        9.5: "2.375rem",
        10.5: "2.625rem",
        // ... (all your spacing values remain unchanged)
        203: "50.75rem",
        230: "57.5rem",
      },

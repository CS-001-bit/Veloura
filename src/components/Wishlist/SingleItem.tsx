    ...
    <div className="flex items-center border-t border-gray-200 py-6 px-10 hover:bg-gray-50 transition duration-300">
      ...
      <div className="min-w-[83px]">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-10 bg-gray-100 border border-gray-300 hover:bg-red-50 hover:border-red-300 hover:text-red-600 transition duration-300"
        >
          <svg
      ...
      <div className="min-w-[205px]">
        <p className="font-montserrat text-xl font-medium text-gray-900">
      ...
      <div className="min-w-[265px]">
        <div className="flex items-center gap-2">
          ...
          <span className="font-montserrat text-red-600">Out of Stock</span>
        </div>
      </div>
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex font-montserrat font-medium text-velourBlack border-2 border-velourGold py-2.5 px-8 rounded-full hover:bg-velourGold hover:text-white transition-all duration-300"
        >
          Add to Cart
        </button>
      </div>

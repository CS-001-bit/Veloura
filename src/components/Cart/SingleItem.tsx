...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-200 py-6 px-10 hover:bg-gray-50 transition duration-300">
      {/* Product Info */}
      <div className="min-w-[400px]">
        <div className="flex items-center gap-6">
          <div className="flex items-center justify-center rounded-lg bg-gray-50 max-w-[90px] w-full h-24 border border-gray-200 overflow-hidden">
            <Image
          ...
          <div>
            <h3 className="font-playfair text-xl text-gray-900 hover:text-velourGold transition duration-300">
              <a href="#">{item.title}</a>
            </h3>
          </div>
        </div>
      ...
      <div className="min-w-[180px]">
        <p className="font-montserrat text-lg font-medium text-gray-900">
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-full border border-gray-300 overflow-hidden">
          <button
            onClick={handleDecreaseQuantity}
            aria-label="Decrease quantity"
            className="flex items-center justify-center w-12 h-12 bg-gray-50 hover:bg-gray-100 text-gray-700 transition duration-200"
            disabled={quantity <= 1}
          >
            <svg
          ...
          <span className="flex items-center justify-center w-16 h-12 border-x border-gray-300 font-montserrat text-gray-900">
            {quantity}
          </span>
      ...
      <div className="min-w-[200px]">
        <p className="font-montserrat text-lg font-medium text-gray-900">
          R{((item.discountedPrice || item.price) * quantity).toFixed(2)}
        </p>
      </div>
      ...
      <div className="min-w-[50px] flex justify-end">
        <button
          ...
          className="flex items-center justify-center rounded-lg w-10 h-10 bg-gray-100 border border-gray-300 text-gray-700 hover:bg-red-50 hover:border-red-300 hover:text-red-600 transition duration-300"
        >
          <svg
            className="fill-current"
            width="22"
